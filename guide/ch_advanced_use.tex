...
from Stellarium's Github website\footnote{\url{https://github.com/Stellarium/stellarium-data/releases/tag/dso-3.15}}:

\noindent\begin{tabular}{lllr}
\toprule
\emph{Version; Edition} & \emph{Filename} & \emph{MD5 hash} & \emph{Size}\\\midrule
3.15; extended & \file{catalog-3.15.dat} & \texttt{5a343f8204eb4a43b4f9ef320d61c4da} & 28MB\\\bottomrule
\end{tabular}
